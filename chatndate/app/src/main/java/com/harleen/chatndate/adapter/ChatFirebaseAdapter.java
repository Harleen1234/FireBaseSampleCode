package com.harleen.chatndate.adapter;
...
import com.harleen.chatndate.supernova_emoji_library.Helper.EmojiconTextView;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel, ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    public ChatFirebaseAdapter(Context context, DatabaseReference ref, String email, ClickListenerChatFirebase mClickListenerChatFirebase) {
    ...
    public int getItemViewType(int position) {
        ...
        if (model.getFile() != null) {
            if (model.getFile().getType().equals("img") && model.getUserModel().getEmail().equals(email)) {
                return RIGHT_MSG_IMG;
            } else {
                return LEFT_MSG_IMG;
            }
        } else if (model.getUserModel().getEmail().equals(email)) {
            return RIGHT_MSG;
        } else {
            return LEFT_MSG;
        }
    ...
    public class MyChatViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mClickListenerChatFirebase.clickImageChat(view, position, model.getUserModel().getEmail(), model.getUserModel().getPhoto_profile(), model.getFile().getUrl_file());
        }
